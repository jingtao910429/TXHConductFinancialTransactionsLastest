...
- (void)setBodyUI{
    ...
    [self navigationBarStyleWithTitle:@"项目类型" titleColor:[UIColor blackColor]  leftTitle:nil leftImageName:@"back" leftAction:@selector(popVC) rightTitle:nil rightImageName:nil rightAction:nil];
