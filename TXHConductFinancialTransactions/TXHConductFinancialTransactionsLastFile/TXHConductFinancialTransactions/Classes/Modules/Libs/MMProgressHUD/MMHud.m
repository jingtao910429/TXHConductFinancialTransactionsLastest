...
- (void)applyLayoutFrames {
    ...
    if(self.statusLabel.text==nil&self.titleLabel.text==nil){
    self.progressViewContainer.frame=CGRectMake(self.contentAreaFrame.origin.x+5, self.contentAreaFrame.origin.y, 37, 37);
    }
